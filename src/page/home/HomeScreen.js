...
class HomeScreen extends React.Component {
  render() {
    return (
      <View>
        <CardSection
          style={{padding: 0, backgroundColor: '#ef8f04', paddingBottom: 8}}>
          <Card
            style={{
              flex: 1,
              flexDirection: 'row',
        ...
        <CardSection
          ...
          <Card
            ...
            <View style={{alignItems: 'center'}}>
              <Icon name="md-journal" size={25} />
              <Text>待收货</Text>
            </View>
            <View style={{alignItems: 'center'}}>
              <Icon name="md-chatbox" size={25} />
              <Text>评价</Text>
            </View>
          </Card>
          <Card
            ...
            <View style={{alignItems: 'center'}}>
              <Icon name="md-chatbox" size={25} color="orange" />
              <Text>评价</Text>
            </View>
          </Card>
        </CardSection>
